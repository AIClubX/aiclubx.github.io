...
import Jobs from './pages/resources/Jobs';
import OpenProjects from './pages/resources/OpenProjects';
        ...
        <Router>
          <Routes>
            ...
            <Route element={<MainLayout />}>
              ...
              <Route path="resources/jobs" element={<Jobs />} />
              <Route path="resources/projects" element={<OpenProjects />} />
